...
public class InMemoryBlueprintPersistence implements BlueprintsPersistence {
    ...
    public InMemoryBlueprintPersistence() {
        ...
        Blueprint bp1 = new Blueprint("DiegoMurc2022", "blueprint01",pts1);
        Blueprint bp2 = new Blueprint("DiegoMurc2022", "blueprin02", pts2);
        Blueprint bp3 = new Blueprint("Electronic Arts", "StarWars Fallen Order", pts3);
